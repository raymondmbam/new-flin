  ...
  return (
    <div className={`flex gap-3 mb-5 animate-in ${isUser ? "flex-row-reverse" : "flex-row"}`}>
      ...
      <div className={`flex flex-col gap-2 max-w-[75%] ${isUser ? "items-end" : "items-start"}`}>
        ...
        {/* Image — shown below Flin's text if one was generated */}
      {!isUser && message.imageUrl && (
        <img
          src={message.imageUrl}
          alt="Generated by Flin"
          className="rounded-2xl mt-2 max-w-sm w-full shadow-sm border border-gray-200"
        />
      )}
      {!isUser && message.imageUrl && console.log("Image URL received:", message.imageUrl)}
